                             ...
                             <div class="tab-content">
									...
									<div class="tab-panel active in fade" id="faq">
                                        <div class="panel-group" id="accordion">
                                                <h3 class="margin-bottom" style="margin-left:0px;  text-align:center; color:#56693c;"><strong>Зведені статистичні дані</strong></h3> 
												<p>
											<?php 
												 $result_records =  mysqli_query($linc, "SELECT * FROM student");
												 if (mysqli_num_rows( $result_records)>0) echo "<strong>&nbsp Всього у коледжі навчаеться:&nbsp</strong>".mysqli_num_rows( $result_records)."&nbspстудента(ів), <strong>з яких:</strong>";
											?>
												</p>
