...
<div id="body-bg">
  ...
  <div class="row d-flex  align-items-center  col-12">
    <div class="card container-md  col-10 p-0 border-4  shadow-lg "
      style="max-width: 1040px; color: aliceblue; border-color: #63949E; ">
      <div class="row m-0 shadow">
        ...
        <div class="col-md-8  " style="background-color: #2d7791; color: aliceblue;">
          <div class="card-body">
            ...
            <p class="card-text">Наша система дозволяє ефективно керувати навчальними групами, студентами та
              спеціальностями в одному місці. Кожен користувач, залежно від рівня доступу, може додавати, редагувати або
              переглядати студентські дані з дотриманням прав доступу та цілісності інформації.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row d-flex  align-items-center  col-12 ">
    <div class="card container-md  col-10 p-0 border-4  shadow-lg "
      style="max-width: 1040px; color: aliceblue; border-color: #63949E; margin-top: 25px;">
      <div class="row m-0 shadow">
        <div class="col-md-4 d-flex justify-content-center align-items-center p-0">
        ...
        <div class="col-md-8  " style="background-color: #2d5391; color: aliceblue;">
          <div class="card-body">
            <h5 class="card-title fs-2 fw-bolder"><i class="bi bi-clipboard-data"></i> Аналітика, пошук та звітність
            </h5>
            <p class="card-text">Функціонал системи включає потужну систему фільтрації студентів за різними критеріями:
              вік, соціальна категорія, спеціальність, група, курс тощо. Ви можете формувати вибірки, створювати звіти,
              експортувати дані в Excel та аналізувати зміни за різними показниками.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row m-0 shadow">
        ...
        <div class="col-md-8  " style="background-color: #2d9171; color: aliceblue;">
          <div class="card-body ">
            ...
            <p class="card-text">Система підтримує багаторівневий контроль доступу (переглядач, редактор,
              адміністратор), захищене зберігання паролів та авторизацію користувачів. Всі операції логуються, а доступ
              до функцій чітко регулюється згідно з роллю користувача. Інтерфейс адаптований для комфортної роботи на
              будь-якому пристрої.</p>
          </div>
        </div>
      </div>
    </div>
