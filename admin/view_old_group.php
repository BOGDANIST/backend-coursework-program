...
// Отримання студентів з таблиці old_student для заданої групи
$sql = "SELECT * FROM old_student WHERE s_group='$group' GROUP BY s_id ORDER BY s_pr ASC";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<tr>
										...
										<td class="text-decoration-underline"> <a href="view_old_student.php?id_st=' . $row["s_id"] .  '">Перегляд</a> </td>
                                      </tr>';
                            }
                            echo '	</table></div>';
                        } else {
