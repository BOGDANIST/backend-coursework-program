                    ...
                    <div class="block_search col-lg-3 shadow-lg" style="height:auto; background:#256279; border: 3px solid #004768; margin-left:10px; margin-top:10px; margin-bottom:14px; padding-bottom:10px;  color: #e5e5e5;">
                        ...
                        <form id="filter-form" method="POST" style="display: contents;">
                            ...
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownVzMenu" aria-expanded="false">
                                    Вид замовлення
                                </button>
                                <div id="dropdownVzMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2" style="font-size: 15px;">
                                    <ul class="list-unstyled m-0">
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_vz0" value="Ні"> навч. за регіон. замовл.</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_vz1" value="Так"> навч. за кошти фіз. або юридич. осіб</label></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <!-- Галузь знань -->
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownGzMenu" aria-expanded="false">
                                    Галузь знань
                                </button>
                            ...
                            <!-- Спеціальність -->
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownSpecialtyMenu" aria-expanded="false">
                                    Спеціальність
                                </button>
                            ...
                            <!-- Курс -->
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownCourseMenu" aria-expanded="false">
                                    Курс
                                </button>
                                <div id="dropdownCourseMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2" style="font-size: 15px;">
                                    <ul class="list-unstyled m-0">
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs1" value="1"> I курс</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs2" value="2"> II курс</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs3" value="3"> III курс</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs4" value="4"> IV курс</label></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <!-- ОСВІТА -->
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownOsvitaMenu" aria-expanded="false">
                                    Освіта
                                </button>
                                <div id="dropdownOsvitaMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2" style="font-size: 15px;">
                                    <ul class="list-unstyled m-0">
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_os1" value="Базова загальна середня освіта"> Базова загальна середня освіта</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_os2" value="Повна загальна середня освіта"> Повна загальна середня освіта</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_os3" value="Молодший спеціаліст"> Молодший спеціаліст</label></li>
                                        <li class="dropdown-filter-item"><label><input type="checkbox" name="check_os4" value="Кваліфікований робітник"> Кваліфікований робітник</label></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="block-search-left">
                                ...
                                <ul id="ul-category" style="list-style-type: none; margin-bottom:0px; padding-left:0px; font-size: 15px;">
                                    <li><input type="checkbox" name="check_vg" value="Так" style="margin:0px;"> випускна група</li>
                                </ul>
                            </div>
                            ...
                            <div id="block-search-left">
                                <div id="block-category">
                                    ...
                                    <ul id="ul-category" style="columns: 2; list-style-type: none; margin-bottom:0px; padding-left:0px; font-size: 15px;">
                                        <li><input type="checkbox" name="check_men" value="Чоловік" style="margin:0px;"> чоловік</li>
                                        <li><input type="checkbox" name="check_women" value="Жінка" style="margin:0px;"> жінка</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="block-search-left">
                                ...
                                <div id="block-category">
                                    ...
                                    <input type="number" name="vik_from" value="" style="width:50px; height: 25px; margin:5px; color: #000000;" min="0" max="100">
                                    <label style="font-size: 15px;">до</label>
                                    <input type="number" name="vik_to" value="" style="width:50px; height: 25px; margin:5px; color: #000000;" min="0" max="100">
                            ...
                            <div id="block-search-left">
                                ...
                                <div id="block-category">
                                    ...
                                    <input type="text" name="text_yer" value="" style="width:50px; height: 25px; background:white; font-size: 15px;margin-top:5px; margin-bottom:5px; border:1px solid #cccccc; color:#030303;">
                                </div>
                            </div>
                            ...
                            <div id="block-search-left">
                                <div id="block-category">
                                    ...
                                    <ul id="ul-category" style="list-style-type: none; margin-bottom:0px; padding-left:0px; font-size: 15px;">
                                        <li><input type="checkbox" name="check_mp1" value="Місто" style="margin:0px;">місто</li>
                                        <li><input type="checkbox" name="check_mp2" value="Сільська місцевість" style="margin:0px;">сільська місцевість</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <!-- Область проживання -->
                            <div class="dropdown dropdown-filter-wrapper mb-3">
                                <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownRegionMenu" aria-expanded="false">
                                    Область проживання
                                </button>
                            ...
                            <div id="block-search-left">
                                <div id="block-category">
                                    <div class="dropdown dropdown-filter-wrapper mb-3">
                                        <button class="btn btn-outline-secondary dropdown-toggle dropdown-filter-btn w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#dropdownSocialMenu" aria-expanded="false">
                                            Соціальна категорія
                                        </button>
                                        <div id="dropdownSocialMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2" style="font-size: 15px;">
                                            <ul class="list-unstyled m-0">
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_sirot" value="Так"> діти-сироти та діти позбавлені батьківського піклування</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_peres" value="Так"> переселенці</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_chernob" value="Так"> чорнобильці</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_ivalid" value="Так"> інваліди</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_malozab" value="Так"> малозабезпечені</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_ato" value="Так"> діти учасників АТО</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_uchbd" value="Так"> учасники бойових дій та їх діти</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_ditzag" value="Так"> діти загиблих майданівців</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_stepver" value="Так"> стипендіати Верховної ради</label></li>
                                                <li class="dropdown-filter-item"><label><input type="checkbox" name="check_shaht" value="Так"> шахтарі і діти шахтарів</label></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div  style=" border-top:2px solid #cccccc; margin-bottom:0px; margin-top: 10px;">
                                <button class="col-4 form-control bg-success fs-3" type="button" id="submit-filter" style="margin-top:10px; border-radius:5px;color: #ddfff0;">Пошук</button>
                                <button class="form-control bg-danger fs-3" type="button" id="clear-filter" style="margin-top:10px; border-radius:5px; color: #ffffff;">Очистити</button>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active in fade" id="faq">
                                    ...
                                    <div class="container-fluid d-flex justify-content-end align-items-center mt-3">
                                        <form id="limit-form" method="GET" style="display: inline-flex; gap: 10px; align-items: center;">
                                            <label for="limit">Записів на сторінці:</label>
                                            <select name="limit" id="limit" onchange="AsyncRouter.filterStudents(document.getElementById('filter-form'), 1, this.value)">
