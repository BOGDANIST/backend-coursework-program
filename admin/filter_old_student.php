		...
		<div class="row padding-top-40 d-flex align-content-center">
			<div class="col-md-12">
				...
				<div class="block_search col-lg-3 shadow-lg"
					style="height:auto; background:rgba(29, 123, 105, 0.88); border: 3px solid rgba(62, 112, 135, 0.91); margin-left:10px; margin-top:10px; margin-bottom:14px; padding-bottom:10px;  color: #e5e5e5;">
					...
					<form id="filter-form" method="POST" style="display: contents;">
						...
						<div id="block-search-sort" class="mb-3 fs-3">
							...
							<select name="sort_by" id="sort_by" class="form-select w-auto d-inline-block fs-5">
								...
								<option value="s_dnar" <?= ($sort_by == 's_dnar') ? 'selected' : '' ?>>Роком народження
								</option>
								<option value="operation_date" <?= ($sort_by == 'operation_date') ? 'selected' : '' ?>>
									Датою додавання</option>
								<option value="operation_name" <?= ($sort_by == 'operation_name') ? 'selected' : '' ?>>Тип
									операції</option>
							</select>
						</div>

						<div id="block-search-sort" class="mb-3 fs-3">
							<label for="filter_operation" class="form-label ms-1"><strong>Фільтр типу
									операції:</strong></label>
							<select name="filter_operation" id="filter_operation"
								class="form-select w-auto d-inline-block fs-5">
								<option value="">-- всі --</option>
								<option value="Випущений/а" <?= ($filter_operation == 'Випущений/а') ? 'selected' : '' ?>>
									Випущений/а</option>
						...
						<div id="block-search-sort" class="mb-3 fs-3">
							...
							<select name="sort_dir" id="sort_dir" class="form-select w-auto d-inline-block fs-5">
								...
								<option value="ASC" <?= ($sort_dir == 'ASC') ? 'selected' : '' ?>>від A до Я (зростання)
								</option>
								<option value="DESC" <?= ($sort_dir == 'DESC') ? 'selected' : '' ?>>від Я до A (спадання)
								</option>
							</select>
						</div>
						...
						<div class="dropdown dropdown-filter-wrapper mb-3">
							<button
								...
								aria-expanded="false" aria-controls="dropdownVzMenu">
								Вид замовлення
							</button>
							...
							<div id="dropdownVzMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2"
								...
								<ul class="list-unstyled m-0">
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_vz0"
												value="Ні" <?= $check_vz0 ?>> навч. за регіон. замовл.</label></li>
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_vz1"
												value="Так" <?= $check_vz1 ?>> навч. за кошти фіз. або юридич.
											осіб</label></li>
								</ul>
							</div>
						</div>
						...
						<div class="dropdown dropdown-filter-wrapper mb-3">
							...
							<div id="dropdownSpecialtyMenu"
								class="collapse dropdown-filter-menu border rounded p-3 mt-2" style="font-size: 15px;">
								<ul class="list-unstyled m-0">
									<?php
						...
						<div class="dropdown dropdown-filter-wrapper mb-3">
							<button
								...
								aria-expanded="false" aria-controls="dropdownCourseMenu">
								Курс
							</button>

							<div id="dropdownCourseMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2"
								style="font-size: 15px;">
								<ul class="list-unstyled m-0">
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs1"
												value="1" <?= $check_kurs1 ?>> I курс</label></li>
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs2"
												value="2" <?= $check_kurs2 ?>> II курс</label></li>
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs3"
												value="3" <?= $check_kurs3 ?>> III курс</label></li>
									<li class="dropdown-filter-item"><label><input type="checkbox" name="check_kurs4"
												value="4" <?= $check_kurs4 ?>> IV курс</label></li>
								</ul>
							</div>
						</div>
						...
						<div class="dropdown dropdown-filter-wrapper mb-3">
							<button
								...
								aria-expanded="false" aria-controls="dropdownOsvitaMenu">
								Освіта
							</button>

							<div id="dropdownOsvitaMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2"
								style="font-size: 15px;">
								<ul class="list-unstyled m-0"><label>
										<li class="dropdown-filter-item"><input type="checkbox" name="check_os1"
												value="Базова загальна середня освіта" <?= isset($check_os1) && $check_os1 ? 'checked' : '' ?> style="margin:0px;">Базова загальна
											середня освіта</li>
										<li class="dropdown-filter-item"><input type="checkbox" name="check_os2"
												value="Повна загальна середня освіта" <?= isset($check_os2) && $check_os2 ? 'checked' : '' ?> style="margin:0px;">Повна загальна середня освіта
										</li>
										<li class="dropdown-filter-item"><input type="checkbox" name="check_os3"
												value="Молодший спеціаліст" <?= isset($check_os3) && $check_os3 ? 'checked' : '' ?> style="margin:0px;">Молодший спеціаліст</li>
										<li class="dropdown-filter-item"><input type="checkbox" name="check_os4"
												value="Кваліфікований робітник" <?= isset($check_os4) && $check_os4 ? 'checked' : '' ?> style="margin:0px;">Кваліфікований робітник</li>
									</label>
								</ul>
							</div>
						</div>
						...
						<div id="block-search-left">
							...
							<ul id="ul-category"
								...
								<li><input type="checkbox" name="check_vg" value="Так" <?= $check_vg ?>
										style="margin:0px;"> випускна група</li>
							</ul>
						</div>
						...
						<div id="block-search-left">
							<div id="block-category">
								...
								<ul id="ul-category"
									...
									<li><input type="checkbox" name="check_men" value="Чоловік" <?= $check_men ?>
											style="margin:0px;"> чоловік</li>
									<li><input type="checkbox" name="check_women" value="Жінка" <?= $check_women ?>
											style="margin:0px;"> жінка</li>
								</ul>
							</div>
						</div>
						...
						<div id="block-search-left">
							...
							<div id="block-category">
								...
								<input type="number" name="vik_from" value="<?= htmlspecialchars($vik_from) ?>"
									style="width:50px; height: 25px; margin:5px; color: #000000;" min="0" max="100">
								<label style="font-size: 15px;">до</label>
								<input type="number" name="vik_to" value="<?= htmlspecialchars($vik_to) ?>"
									style="width:50px; height: 25px; margin:5px; color: #000000;" min="0" max="100">
						...
						<div id="block-search-left">
							<p class="header-title"
								style="border-top:2px solid #cccccc; margin-bottom:0px; font-size: 15px;"><strong>Рік
									завершення школи</strong></p>
							<div id="block-category">
								<label style="font-size: 15px;">Рік</label>
								<input type="text" name="text_yer" value="<?= htmlspecialchars($text_yer) ?>"
						...
						<div id="block-search-left">
							<div id="block-category">
								...
								<ul id="ul-category"
									style="list-style-type: none; margin-bottom:0px; padding-left:0px; font-size: 15px;">
									<li><input type="checkbox" name="check_mp1" value="Місто" <?= $check_mp1 ?>
											style="margin:0px;">місто</li>
									<li><input type="checkbox" name="check_mp2" value="Сільська місцевість"
											<?= $check_mp2 ?> style="margin:0px;">сільська місцевість</li>
								</ul>
							</div>
						</div>
						...
						<div class="dropdown dropdown-filter-wrapper mb-3">
							<button
								...
								aria-expanded="false" aria-controls="dropdownRegionMenu">
								Область проживання
							</button>

							<div id="dropdownRegionMenu" class="collapse dropdown-filter-menu border rounded p-3 mt-2"
								style="font-size: 15px;">
								<ul class="list-unstyled m-0">
									<?php
									$regions = [
							...
							<div id="block-category">
								<div class="dropdown dropdown-filter-wrapper mb-3">
									<button
										...
										aria-expanded="false" aria-controls="dropdownSocialMenu">
										Соціальна категорія
									</button>
									...
									<div id="dropdownSocialMenu"
										...
										<ul class="list-unstyled m-0">
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_sirot" value="Так" <?= $check_sirot ?>> діти-сироти
													та діти позбавлені батьківського піклування</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_peres" value="Так" <?= $check_peres ?>>
													переселенці</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_chernob" value="Так" <?= $check_chernob ?>>
													чорнобильці</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_ivalid" value="Так" <?= $check_ivalid ?>>
													інваліди</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_malozab" value="Так" <?= $check_malozab ?>>
													малозабезпечені</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_ato" value="Так" <?= $check_ato ?>> діти учасників
													АТО</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_uchbd" value="Так" <?= $check_uchbd ?>> учасники
													бойових дій та їх діти</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_ditzag" value="Так" <?= $check_ditzag ?>> діти
													загиблих майданівців</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_stepver" value="Так" <?= $check_stepver ?>>
													стипендіати Верховної ради</label></li>
											<li class="dropdown-filter-item"><label><input type="checkbox"
														name="check_shaht" value="Так" <?= $check_shaht ?>> шахтарі і
													діти шахтарів</label></li>
										</ul>
									</div>
								</div>
						...
						<div style=" border-top:2px solid #cccccc; margin-bottom:0px; margin-top: 10px;">
							<input class="col-4 form-control bg-success fs-3" type="submit" name="submit_search"
								id="submit-filter" value="Пошук"
								style="margin-top:10px; border-radius:5px;color: #ddfff0;" />
							<button class="form-control bg-danger fs-3" type="button" id="clear-filter"
								name="clear_search" style="margin-top:10px; border-radius:5px; color: #ffffff;">
								Очистити
							</button>
								...
								<div class="container-fluid d-flex justify-content-end align-items-center ">
									...
									<form method="GET" action="">
										...
										<select name="limit" id="limit"
											onchange="AsyncRouter.filterOldStudents(document.getElementById('filter-form'), 1, this.value)">
											<?php foreach ([10, 25, 50, 100] as $opt): ?>
												<option value="<?php echo $opt; ?>" <?php if ($opt == $limit)
													   echo 'selected'; ?>><?php echo $opt; ?></option>
											<?php endforeach; ?>
										</select>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Допоміжна функція для отримання поточного ліміту
        const getLimit = () => document.getElementById('limit') ? document.getElementById('limit').value : 50;
        ...
        // 2. Робимо ЄДИНИЙ стартовий виклик для завантаження архіву
        AsyncRouter.filterOldStudents(form, 1, getLimit());
        ...
        if (excelExport && form) {
            excelExport.addEventListener('click', function (e) {
                ...
                // Виклик експорту з правильним синтаксисом передачі параметрів (true означає, що це архів)
                AsyncRouter.exportStudentsToExcel(form, 1, 50, true);
            });
        }
    });
</script>
