...
<html lang="en">
  ...
  <button type="submit" name="download_excel" value="yes" formaction="search_excel.php">Завантажити Excel</button>
	...
	{ $query_all='';
		...
		//Вид замовлення
		$vz='';
						$check_vz0=$_GET ["check_vz0"];
				 		$check_vz1=$_GET ["check_vz1"];
		...
		//Галузь знань
		$gz='';
						 $check_gz0=$_GET ["check_gz0"];
				 		 $check_gz1=$_GET ["check_gz1"];
						 $check_gz2=$_GET ["check_gz2"];
						 $check_gz3=$_GET ["check_gz3"];
						 $check_gz4=$_GET ["check_gz4"];
						 $check_gz5=$_GET ["check_gz5"];
		...
		//Спеціальність
		$sp='';
						 $check_sp0=$_GET ["check_sp0"];
				 		 $check_sp1=$_GET ["check_sp1"];
						 $check_sp2=$_GET ["check_sp2"];
						 $check_sp3=$_GET ["check_sp3"];
						 $check_sp4=$_GET ["check_sp4"];
						 $check_sp5=$_GET ["check_sp5"];
						 $check_sp6=$_GET ["check_sp6"];
						 $check_sp7=$_GET ["check_sp7"];
		...
		//Курс
		$sk='';
						$check_sk1=$_GET ["check_kurs1"];
						$check_sk2=$_GET ["check_kurs2"];
						$check_sk3=$_GET ["check_kurs3"];
						$check_sk4=$_GET ["check_kurs4"];
						if($check_sk1=="1")
							{$query_sk1="'".$check_sk1."'";
							 $sk=',';}
						if($check_sk2=="2")
		...
		//Випускна група
						...
						$check_vg=$_GET ["check_vg"];
						if($check_vg=="Так") $query_vg="AND s_vip IN('Так')";
						else $query_vg="AND s_vip IN('Так','Ні','')";
							 
		//Стать
		$st='';
						$check_men=$_GET ["check_men"];
				 		$check_women=$_GET ["check_women"];
		...
		//Освіта
		$os='';
						echo $check_os1=$_GET ["check_os1"];
				 		echo $check_os2=$_GET ["check_os2"];
		...
		//Місце проживання
		$mp='';
						$check_mp1=$_GET ["check_mp1"];
				 		$check_mp2=$_GET ["check_mp2"];
